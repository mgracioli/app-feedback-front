  ...
  <div class="mt-16">
    <form @submit.prevent="handleSubmit">
      <label class="block">
        ...
        <input id="email-field" v-model="state.email.value" type="email"
      ...
      <label class="block mt-9">
        ...
        <input id="password-field" v-model="state.password.value" type="password"
          class="block w-full px-4 py-3 mt-1 text-lg bg-gray-100 border-2 border-transparent rounded"
      ...
      <button id="submit-button" type="submit" :class="{ 'opacity-50': state.isLoading }"
